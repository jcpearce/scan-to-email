...
public class MailItemInsert  {
    ...
    public MailItemInsert(Client client, String filename, boolean envelope, int numpages, String filenopathname, String id, String parentid) {
