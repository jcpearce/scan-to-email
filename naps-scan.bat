...
.\winbin\naps2-7.3.0-win\App\NAPS2.Console.exe --force --deskew --device "fi-7260" --driver %1 --source %2 --dpi 200 --verbose --bitdepth color --output ".\tempimages\%3" >stdout.txt 2>stderr.txt
